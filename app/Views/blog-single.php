            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <h3 class="widget_title">Your Booking</h3>
                            <img class="hotel_img author_img rounded-circle" src="image/room1.jpg" alt="">
                            ...
                            <div class="blog_info text-right">
                                ...
                                <ul class="blog_meta list_style">
                                    ...
                                    <li><span>Check in</span> 12/06/2021</li>
                                    <li><span>Check out</span>12/07/2021</li>
                                    <li class="divider"></li>
                                    <li><span>Room Type</span>Superior Single</li>
                                    <li><span>persons</span> Max 2 Persons</li>
                                    <li class="divider"></li>
                                    <li><span>Qty</span>1</li>
                                    <li><span>Days</span> 1 Nights</li>
                                    <li><span>Price</span>Rp 220.000</li>
                                    <li><span>(1x) Superior Family (1 Night)</span> <strong>Rp 220.000</strong></li>

                                    <!-- <li><span>Taxes And Fees (0 %)</span> <strong>Rp 0</strong></li> -->
                        ...
                        <div class="media post_item hotel_img">
                                <img src="image/room1.jpg" alt="post">
